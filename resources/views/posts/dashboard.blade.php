            ...
            <div class="sidebar">
                ...
                <div class="row pt-4 ">
                    <div class="col-md-2 mt-4 d-flex  left  flex-column gap-3">
                        ...
                        <i class="bi bi-house" style="color: red; font-size: 25px;" id="hover-house"></i>
                        <i class="bi bi-cookie" style="color: red; font-size: 25px;" id="hover-house"></i>
                        <i class="bi bi-heart-fill" style="color: red; font-size: 25px;" id="hover-house"></i>
                        <i class="bi bi-person-circle" style="color: red; font-size: 25px;" id="hover-house"></i>
                    ...
                    <div class="col-md-12">
                                    ...
                                    {{-- <div class="main-kategori">
                                        ...
                                        {{-- akhir kategori --}}
                                         ...
                                         <div class="row  d-flex justify-content-center gap-5" style="margin-left: 120px;  margin-top: 100px">
